...
namespace Microwave.Test.Integration
{
    ...
    public class TDStep3
    {
        ...
        public void Setup()
        {
            ...
            ui = new UserInterface(powerButton, timeButton, startCancelButton, removeTimeButton, door, display, light, cooker);
            cooker.UI = ui;
        }
        ...
        public void CookController_Display_ShowTime_0_59_FakedTimer()
        {
            ...
            ui = new UserInterface(
                powerButton, timeButton, startCancelButton, removeTimeButton,
